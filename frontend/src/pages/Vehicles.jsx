      ...
      <div className="bg-white rounded-2xl shadow-lg w-full max-w-md p-6">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <Input
            ...
            placeholder="Westlands — Kileleshwa — CBD"
            value={form.route}
            onChange={handleChange}
          />
          <Input
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-display font-semibold text-ink">Vehicles</h1>
          <p className="text-slate text-sm mt-1">Manage your fleet</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl border border-cloud shadow-sm flex flex-col items-center py-20 px-6 text-center">
          ...
          <p className="text-slate text-sm max-w-xs mb-6">
            Add the vehicles in your fleet to start managing routes, students, and compliance documents.
          </p>
          <Button onClick={() => setModalOpen(true)}>
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
          ...
          <table className="w-full text-sm">
            <thead className="bg-paper border-b border-cloud">
              <tr>
                ...
                <th className="px-5 py-3 text-left font-medium text-slate hidden sm:table-cell">Route</th>
                  ...
                  <td className="px-5 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <button
                        ...
                        className="text-slate hover:text-error transition-colors disabled:opacity-50"
                        title="Delete"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
