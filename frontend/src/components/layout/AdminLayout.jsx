  ...
  return (
    <div className="flex h-screen bg-paper overflow-hidden">
      ...
      <div
        ...
        `}
      >
        <aside className="w-60 bg-ink flex flex-col h-screen">
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        {/* Top bar */}
        <header className="bg-white border-b border-cloud px-4 sm:px-6 py-3 flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-3">
            <button
            ...
            <div>
              <p className="text-slate text-xs">Super Admin Portal</p>
              <h2 className="text-ink font-semibold text-sm sm:text-base leading-tight">ShuleRyde</h2>
            </div>
          </div>
          <div className="w-8 h-8 rounded-full bg-red-100 flex items-center justify-center flex-shrink-0">
            <span className="text-red-700 font-semibold text-sm">{admin?.full_name?.[0] || 'A'}</span>
          </div>
        </header>
